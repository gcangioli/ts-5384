...
* differential.element[1].id = "Forecast.forecast.creationDate"
* differential.element[1].path = "Forecast.forecast.creationDate"
...
* differential.element[2].id = "Forecast.forecast.status"
* differential.element[2].path = "Forecast.forecast.status"
...
* differential.element[3].id = "Forecast.forecast.description"
* differential.element[3].path = "Forecast.forecast.description"
...
* differential.element[4].id = "Forecast.forecast.supportingInformation"
* differential.element[4].path = "Forecast.forecast.supportingInformation"
...
* differential.element[5].id = "Forecast.forecast.date"
* differential.element[5].path = "Forecast.forecast.date"
...
* differential.element[6].id = "Forecast.forecast.date.type"
* differential.element[6].path = "Forecast.forecast.date.type"
...
* differential.element[7].id = "Forecast.forecast.date.value"
* differential.element[7].path = "Forecast.forecast.date.value"
